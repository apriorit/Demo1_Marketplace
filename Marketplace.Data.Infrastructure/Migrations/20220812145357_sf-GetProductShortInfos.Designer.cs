...
namespace Marketplace.Data.Infrastructure.Migrations
{
    ...
    [Migration("20220812145357_sf-GetProductShortInfos")]
    partial class sfGetProductShortInfos
    {
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9919), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 100.0
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9925), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 300.0
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9936), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Main"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9938), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Additional"
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationSubCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9940), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9941), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9942), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            InformationCategoryId = 2,
                            IsActive = true,
                            Name = "Size"
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 12, 14, 53, 57, 190, DateTimeKind.Unspecified).AddTicks(9966), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            InformationCategoryId = 2,
                            IsActive = true,
                            Name = "Type"
