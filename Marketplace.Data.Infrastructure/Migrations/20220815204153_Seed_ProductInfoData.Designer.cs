...
namespace Marketplace.Data.Infrastructure.Migrations
{
    ...
    [Migration("20220815204153_Seed_ProductInfoData")]
    partial class Seed_ProductInfoData
    {
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(991), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 100.0
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(996), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 300.0
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(1138), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Main"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(1140), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Additional"
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationSubCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(1141), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(1142), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(1144), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            InformationCategoryId = 2,
                            IsActive = true,
                            Name = "Size"
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 41, 52, 563, DateTimeKind.Unspecified).AddTicks(1145), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            InformationCategoryId = 2,
                            IsActive = true,
                            Name = "Type"
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.ProductInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            Information = "Detail Info Toyota",
                            InformationSubCategoryId = 1,
                            IsActive = true,
