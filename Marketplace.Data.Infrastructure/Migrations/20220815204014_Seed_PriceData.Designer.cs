...
namespace Marketplace.Data.Infrastructure.Migrations
{
    ...
    [Migration("20220815204014_Seed_PriceData")]
    partial class Seed_PriceData
    {
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6024), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 100.0
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6030), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 300.0
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6178), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Main"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6205), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Additional"
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationSubCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6207), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6209), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 15, 20, 40, 13, 478, DateTimeKind.Unspecified).AddTicks(6210), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            InformationCategoryId = 2,
                            IsActive = true,
                            Name = "Type"
