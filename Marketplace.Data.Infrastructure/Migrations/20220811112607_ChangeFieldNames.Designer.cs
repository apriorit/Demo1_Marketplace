...
namespace Marketplace.Data.Infrastructure.Migrations
{
    ...
    [Migration("20220811112607_ChangeFieldNames")]
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 11, 11, 26, 7, 530, DateTimeKind.Unspecified).AddTicks(3172), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 100.0
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 11, 11, 26, 7, 530, DateTimeKind.Unspecified).AddTicks(3180), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Price = 300.0
                        });
            ...
            modelBuilder.Entity("Marketplace.Data.Models.Stocks.InformationCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 11, 11, 26, 7, 530, DateTimeKind.Unspecified).AddTicks(3193), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Main"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 8, 11, 11, 26, 7, 530, DateTimeKind.Unspecified).AddTicks(3194), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            IsActive = true,
                            Name = "Additional"
                        });
